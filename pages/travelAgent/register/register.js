// pages/travel/register/register.js
...
Page({
    ...
    addressChange: function(e){
        console.log('输入旅行社地址', e);
        let address = e.detail.value;
        this.data.address = address;
    },

    // 输入社会统一信用代码
    certificateChange:function(e){
        console.log('输入社会统一信用代码', e);
    ...
    isOmitted: function () {
        let obj = this.data;
        console.log('-----------',obj)
        if (!obj.name || !obj.mobile || !obj.code || !obj.authPic || !obj.address || !obj.creditCode) {
            return true
        } else {
            return false
        }
        ...
        success: function (res) {
          if (res.statusCode === 200 && res.data.code === 200) {
            ...
            that.setData({
              ...
              address: res.data.data[0].orgAddr,
